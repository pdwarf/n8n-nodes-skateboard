...
import { isCredentialTypeClass, findClassProperty, findObjectProperty, getStringLiteralValue, getBooleanLiteralValue, } from '../utils/index.js';
    ...
    return function (fixer) {
        if (typeOptionsProperty?.value?.type === 'ObjectExpression') {
            ...
            if (typeOptionsProperty.value.properties.length > 0) {
                const lastProperty = typeOptionsProperty.value.properties[typeOptionsProperty.value.properties.length - 1];
